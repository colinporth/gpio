...
//  internal memory for BCM 2835 device registers. You must call this (successfully) before calling any other
//  functions in this library (except bcm2835_set_debug).
//  If bcm2835_init() fails by returning 0, calling any other function may result in crashes or other failures.
...
*/
extern unsigned int bcm2835_version();
//}}}
...
/*! Start AUX SPI operations.
  ...
  \return 1 if successful, 0 otherwise (perhaps because you are not running as root)
*/
extern int bcm2835_aux_spi_begin();
//}}}
//{{{
/*! End AUX SPI operations.
   ...
   are returned to their default INPUT behaviour.
 */
extern void bcm2835_aux_spi_end();
//}}}
//{{{
